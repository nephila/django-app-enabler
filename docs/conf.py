...
release = app_enabler.__version__
...
latex_documents = [
    ("index", "app_enabler.tex", "App Enabler Documentation", "Nephila", "manual"),
]
...
man_pages = [("index", "app_enabler", "App Enabler Documentation", ["Nephila"], 1)]
